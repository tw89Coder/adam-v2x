...
constexpr uint32_t MAGIC_SESSION_ACK   = 0x56325841; // "V2XA"
...
struct UDPControlHeader {
    uint32_t magic;         // MAGIC_SESSION_START, MAGIC_SESSION_ACK, MAGIC_SESSION_END, or MAGIC_BATCH_END
...
public:
     ...
     * Streams batch matrix sweeps over UDP at precise arrival rate lambda with session handshakes and ACK validation.
     */
