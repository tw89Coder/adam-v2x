...
std::string ConsolePresenter::reset() {
    return "\033[0m";
}
std::string ConsolePresenter::green() {
    return safe();
}
std::string ConsolePresenter::red() {
    return crit();
}
std::string ConsolePresenter::yellow() {
    return warn();
}
std::string ConsolePresenter::blue() {
    return info();
}

std::string ConsolePresenter::frame() {
    return "\033[90m";
}
std::string ConsolePresenter::info() {
    return "\033[36m";
}
std::string ConsolePresenter::safe() {
    return "\033[32m";
}
std::string ConsolePresenter::warn() {
    return "\033[33m";
}
std::string ConsolePresenter::crit() {
    return "\033[1;31m";
}
std::string ConsolePresenter::data() {
    return "\033[37m";
}
std::string ConsolePresenter::label() {
    return "\033[1;34m";
}
