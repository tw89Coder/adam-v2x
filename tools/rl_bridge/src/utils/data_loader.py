"""
@file data_loader.py
@brief Telemetry data loader parsing historical CSV logs generated by the C++ simulation harness.

This module provides data loading utilities. It parses file matching patterns, loads 
Pandas DataFrames representing single or mixed trajectories, and shuffles window 
slices to minimize chronological context bias during offline DRL training.
"""
